...
public class DiaryServiceTests {
    ...
    public void saveDiaryTest() {
        ...
        diaryExample = diaryService.cascadeSave(diaryExample);
    ...
    public void deleteDiaryByIdTest() {
        ...
        if(!diaries.iterator().hasNext()) {
            System.out.println("None diaries");
        } else {
    ...
    public void updateDiaryTest() {
        ...
        if(!diaries.iterator().hasNext()) {
            ...
            if (!updatedDiary.getSubjects().iterator().hasNext()) {
                System.out.println("None subject in diary");
            } else {
